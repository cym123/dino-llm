...
import torch
from dinollm.moe import BaseMoeBackend
...
def fused_experts_impl(
    ...
    from dinollm.kernel import fused_moe_kernel_triton, moe_sum_reduce_triton
    from dinollm.layers import gelu_and_mul, silu_and_mul
