#include <dinollm/nccl227.h>
#include <dinollm/tensor.h>
#include <dinollm/utils.cuh>
#include <dinollm/utils.h>
...
public:
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("dinollm.NCCLWrapper", NCCLWrapper,
                                    tvm::ffi::Object);
